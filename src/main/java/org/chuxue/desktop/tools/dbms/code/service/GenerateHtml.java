...
public class GenerateHtml {
	...
	public static void generate(SysDbmsGenerateCodeInfo sysDbmsGenerateCodeInfo, SysDbmsTabsInfo tabsInfo,
		...
		String subNameIdString = subPathString.replace(".", "_") + "_"
		...
		for (SysDbmsTabsColsInfo sysDbmsTabsColsInfo : colsInfos) {
			if (sysDbmsTabsColsInfo.getUserIndex() != null && !"".equals(sysDbmsTabsColsInfo.getUserIndex())) {
				...
				stringBuilder
						.append("							<label class=\"col-sm-3 control-label text-right font16\">"
								+ colsDescString + ":</label>\r\n");
				stringBuilder.append("							<div class=\"col-sm-9\">\r\n");
				stringBuilder
						.append("								<input type=\"text\" class=\"form-control\" id=\"search_"
								+ subNameIdString + "_" + colsNameString + "\" name=\"" + colsNameString
								+ "\" placeholder=\"" + colsDescString + "\" />\r\n");
				stringBuilder.append("							</div>\r\n");
				stringBuilder.append("						</div>\r\n");
				stringBuilder.append("					</div>\r\n");
			}
		...
		stringBuilder.append("						<button class=\"btn btn-primary\" id=\"make_sure_search_"
				+ subNameIdString + "_button_id\">确定</button>\r\n");
		stringBuilder.append("					</div>\r\n");
		stringBuilder.append("				</div>\r\n");

		stringBuilder.append("				<div id=\"" + subNameIdString + "_toolbar\" class=\"btn-group\">\r\n");
		stringBuilder.append("					<button type=\"button\" class=\"btn btn-default\" id=\"addnew_"
				+ subNameIdString + "\">\r\n");
		stringBuilder.append("						<i class=\"glyphicon glyphicon-plus\"></i> 新增\r\n");
		stringBuilder.append("					</button>\r\n");
		stringBuilder.append("					<button type=\"button\" class=\"btn btn-default\" id=\"editold_"
				+ subNameIdString + "\">\r\n");
		stringBuilder.append("						<i class=\"glyphicon glyphicon-pencil\"></i> 修改\r\n");
		stringBuilder.append("					</button>\r\n");
		stringBuilder.append("					<button type=\"button\" class=\"btn btn-default\" id=\"deleteold_"
				+ subNameIdString + "\">\r\n");
		stringBuilder.append("						<i class=\"glyphicon glyphicon-remove\"></i> 删除\r\n");
		stringBuilder.append("					</button>\r\n");
		stringBuilder.append("				</div>\r\n");
		stringBuilder.append("				<table class=\"table table-striped table-bordered\" id=\"" + subNameIdString
				+ "_datagrid\" data-toggle=\"" + subNameIdString + "_datagrid\"></table>\r\n");
		stringBuilder.append("			</div>\r\n");
		stringBuilder.append("		</div>\r\n");
		stringBuilder.append("	</section>\r\n");
		stringBuilder.append("	\r\n");
		...
		stringBuilder.append("	<div class=\"modal fade\" id=\"" + subNameIdString
				+ "_modal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"my_" + subNameIdString
				+ "\" aria-hidden=\"true\">\r\n");
		...
		stringBuilder
				.append("					<h4 class=\"modal-title\" id=\"my_" + subNameIdString + "\">编辑信息</h4>\r\n");
		stringBuilder.append("				</div>\r\n");
		stringBuilder.append("				<div class=\"modal-body\">\r\n");
		stringBuilder.append("					<input type=\"text\" style=\"display:none;\" id=\"" + subNameIdString
				+ "_uuid\" name=\"uuid\" />\r\n");
		stringBuilder.append("					<input type=\"text\" style=\"display:none;\" id=\"" + subNameIdString
				+ "_deleteFlag\" name=\"deleteFlag\" />\r\n");
		stringBuilder.append("					<input type=\"text\" style=\"display:none;\" id=\"" + subNameIdString
				+ "_discription\" name=\"discription\" />\r\n");
		for (SysDbmsTabsColsInfo sysDbmsTabsColsInfo : colsInfos) {
			// 属性
			...
			stringBuilder
					.append("						<label class=\"col-sm-3 control-label text-right font16\" style=\"height: 34px;padding-top: 5px;\">"
							+ colsDescString + ":</label>\r\n");
			stringBuilder.append("						<div class=\"col-sm-9\">\r\n");
			stringBuilder.append("							<input type=\"text\" class=\"form-control\" id=\""
					+ subNameIdString + "_" + colsNameString + "\" name=\"" + colsNameString + "\" placeholder=\""
					+ colsDescString + "\"/>\r\n");
			stringBuilder.append("						</div>\r\n");
			stringBuilder.append("					</div>\r\n");
		}
		...
		stringBuilder.append("					<button type=\"button\" class=\"btn btn-primary\" id=\""
				+ subNameIdString + "_save_button\">提交</button>\r\n");
		stringBuilder.append("				</div>\r\n");
		stringBuilder.append("			</div>\r\n");
		stringBuilder.append("		</div>\r\n");
		stringBuilder.append("	</div>\r\n");
		...
		// 结尾
		stringBuilder.append("	<script type=\"text/javascript\" src=\"/pages/" + subPathString.replace(".", "/") + "/"
				+ sysDbmsGenerateCodeInfo.getClassName().toLowerCase() + ".js\"></script>\r\n");
	...
	public static void generateDetail(SysDbmsGenerateCodeInfo sysDbmsGenerateCodeInfo, SysDbmsTabsInfo tabsInfo,
		...
		stringBuilder.append("				<input type=\"text\" style=\"display:none;\" id=\"" + subNameIdString
				+ "_uuid\" name=\"uuid\" th:value=\"${" + tabsNameString + ".uuid}\"/>\r\n");
		stringBuilder.append("				<input type=\"text\" style=\"display:none;\" id=\"" + subNameIdString
				+ "_deleteFlag\" name=\"deleteFlag\"  th:value=\"${" + tabsNameString + ".deleteFlag}\"/>\r\n");
		stringBuilder.append("				<input type=\"text\" style=\"display:none;\" id=\"" + subNameIdString
				+ "_discription\" name=\"discription\" th:value=\"${" + tabsNameString + ".discription}\"/>\r\n");
		...
		for (SysDbmsTabsColsInfo sysDbmsTabsColsInfo : colsInfos) {
			...
			stringBuilder.append("						<div class=\"col-sm-9\">\r\n");
			stringBuilder.append("							<input type=\"text\" class=\"form-control\" id=\""
					+ subNameIdString + "_" + colsNameString + "\" name=\"" + colsNameString + "\" th:value=\"${"
					+ tabsNameString + "['" + colsNameString + "']}\" placeholder=\"" + colsDescString
					+ "\" disabled=\"disabled\"/>\r\n");
			stringBuilder.append("						</div>\r\n");
			stringBuilder.append("					</div>\r\n");
		}
		...
		stringBuilder.append("					<button type=\"button\" class=\"btn btn-primary\" id=\""
				+ subNameIdString + "_edit_button\">编辑</button>\r\n");
		stringBuilder.append("					<button type=\"button\" class=\"btn btn-primary\" id=\""
				+ subNameIdString + "_save_button\" style=\"display: none;\">提交</button>\r\n");
		stringBuilder.append("					<button type=\"button\" class=\"btn btn-danger\" id=\""
				+ subNameIdString + "_exit_button\">关闭</button>\r\n");
		stringBuilder.append("				</div>\r\n");
		stringBuilder.append("			</div>\r\n");
		stringBuilder.append("		</div>\r\n");
		stringBuilder.append("	</section>\r\n");
		...
		// 结尾
		stringBuilder.append("	<script type=\"text/javascript\" src=\"/pages/" + subPathString.replace(".", "/") + "/"
				+ sysDbmsGenerateCodeInfo.getClassName().toLowerCase() + "detail.js\"></script>\r\n");
		stringBuilder.append("</body>\r\n");
		stringBuilder.append("</html>\r\n");
		stringBuilder.append("\r\n");
