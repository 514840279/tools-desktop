...
import org.chuxue.desktop.tools.dbms.tabs.dao.SysDbmsTabsTypeInfoDao;
...
public class SysDbmsTabsTypeInfoService extends BaseServiceImpl<SysDbmsTabsTypeInfo>
		implements BaseService<SysDbmsTabsTypeInfo> {
	//
	@Autowired
