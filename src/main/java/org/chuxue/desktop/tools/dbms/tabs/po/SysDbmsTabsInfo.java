package org.chuxue.desktop.tools.dbms.tabs.po;
...
public class SysDbmsTabsInfo implements Serializable {
	...
	/**
	 * 方法名 ： setJdbcUuid 功 能 ： 设置变量 jdbcUuid 的值
	 */
	...
	/**
	 * 方法名 ： setTabsDesc 功 能 ： 设置变量 tabsDesc 的值
	 */
	...
	/**
	 * 方法名 ： setTypeUuid 功 能 ： 设置变量 typeUuid 的值
	 */
	...
	/**
	 * 方法名 ： setTabsName 功 能 ： 设置变量 tabsName 的值
	 */
	...
	/**
	 * 方法名 ： setTabsOrder 功 能 ： 设置变量 tabsOrder 的值
	 */
	...
	/**
	 * 方法名 ： setTabsRows 功 能 ： 设置变量 tabsRows 的值
	 */
	...
	/**
	 * 方法名 ： setTabsSpace 功 能 ： 设置变量 tabsSpace 的值
	 */
	...
	/**
	 * 方法名 ： setDiscription 功 能 ： 设置变量 discription 的值
	 */
	...
	/**
	 * 方法名 ： setCreateTime 功 能 ： 设置变量 createTime 的值
	 */
	...
	/**
	 * 方法名 ： setCreateUser 功 能 ： 设置变量 createUser 的值
	 */
	...
	/**
	 * 方法名 ： setUpdateTime 功 能 ： 设置变量 updateTime 的值
	 */
	...
	/**
	 * 方法名 ： setUpdateUser 功 能 ： 设置变量 updateUser 的值
	 */
	...
	/**
	 * 方法名 ： setDeleteFlag 功 能 ： 设置变量 deleteFlag 的值
	 */
	...
	public String toString() {
		return "SysDbmsTabsInfo [uuid=" + uuid + ", jdbcUuid=" + jdbcUuid + ", tabsDesc=" + tabsDesc + ", typeUuid="
				+ typeUuid + ", tabsName=" + tabsName + ", tabsOrder=" + tabsOrder + ", tabsRows=" + tabsRows
				+ ", tabsSpace=" + tabsSpace + ", discription=" + discription + ", createTime=" + createTime
	...
	/**
	 * 方法名 ： setDbType 功 能 ： 设置变量 dbType 的值
	 */
